  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // Remove the IconButton for About Developers
        ],
      ),
                    ...
                    children: [
                      ...
                      StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final projects = snapshot.data?.docs ?? [];
                          if (projects.isEmpty) {
                            return const Center(child: Text('No liked projects found.'));
                          }
                          return SizedBox(
                            height: 220,
                            child: ListView.separated(
                        ...
                        children: [
                          ...
                          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final projects = snapshot.data?.docs ?? [];
                              if (projects.isEmpty) {
                                return const Center(child: Text('You have not liked any projects yet.'));
                              }
                              return SizedBox(
                                height: 220,
                                child: ListView.separated(
